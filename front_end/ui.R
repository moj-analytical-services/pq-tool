  ...
  fluidRow(
    column(4,
           textInput(inputId = "question", 
                     label = "Search Text",
                     value = " To ask Her Majestyâ€™s Government whether any complaint has been made to the Judicial Conduct Investigations Office about the conduct of Mrs Justice Hogg in the case of Ellie Butler.")
    ),
